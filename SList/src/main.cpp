...
int main(){
    ...
    printf("DEBUG: &mylist=%p first=%p last=%p first->next=%p size=%zu\n", (void*)&mylist, (void*)mylist.first, (void*)mylist.last, (void*)(mylist.first?mylist.first->next:NULL), mylist.size);
    destroy(&mylist);
    printf("链表清除完成.\n");
